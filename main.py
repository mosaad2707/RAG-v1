...
Based on the following research papers, provide an answer to the user's query. Make sure to reference the sources and relevant authors you use and if you cannot answer using the research papers then mention it . Don't make up answers by yourself.
Research Papers:
{paper_summaries}
"""
